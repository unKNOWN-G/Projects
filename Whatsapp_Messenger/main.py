...
event = "Republic_Day"
contact_names = open(file_dir + event + "/Contact.txt", "r").read().split("\n")
...
for num in range(len(contact_names)):
    whatsapp_automater(contact_names[num])
